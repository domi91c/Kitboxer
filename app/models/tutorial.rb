class Tutorial < ApplicationRecord
  ...
  def create_initial_steps
    ...
    step2 = steps.build(number: 2, title: "This is a step title for another step", body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in rutrum lectus, feugiat blandit mi. Suspendisse potenti. Nulla sollicitudin posuere rutrum. Vivamus sodales nunc eu laoreet blandit. ")
    step1.save
    step2.save
  end
end